...
import CaseStudy.service.implement.IBooking;
...
public class Booking implements IBooking {
    ...
    public void displayBooking() {
        CaseStudy.repository.Booking bookingRepository = new CaseStudy.repository.Booking();
        ...
        for (CaseStudy.model.Booking booking : bookingList){
            ...
            CaseStudy.model.Customer customer = customerRepository.getCustomerById(booking.getCustomerCode());
    ...
    private void addNewBooking(String typeDislay, Boolean hasContractor) {
        ...
        CaseStudy.model.Booking booking = new CaseStudy.model.Booking(bookingCode, checkInDate, checkOutDate, customerCode, serviceCode);
    ...
    public int getBookingByCode(ArrayList<CaseStudy.model.Booking> list, String code){
