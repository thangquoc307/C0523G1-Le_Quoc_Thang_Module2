...
public class Facility implements CaseStudy.service.implement.IFacility {
    CaseStudy.repository.Facility facilityRepository = new CaseStudy.repository.Facility();
    @Override
    public void displayFacility() {
        ArrayList<CaseStudy.model.IFacility> facilitiesList = facilityRepository.displayFacility();
        for (CaseStudy.model.IFacility element : facilitiesList){
    ...
    public void addNewFacility() {
        ...
        while (true){
            ...
            if (indexOfID(id) != -1){
                System.err.println("ID " + id + " đã sử dụng, mời kiếm cái ID khác nghe");
            } else if (CheckCode.checkFacility(id) == -1) {
                System.err.println("Nhập sai format rồi ba");
            }
            CaseStudy.model.IFacility facility = null;
            Boolean save = false;
            ...
            if (save){
                ArrayList<CaseStudy.model.IFacility> facilitiesList = new ArrayList<>();
    ...
    public void markMaintainedFacility() {
        ...
        CaseStudy.model.IFacility facility = facilityRepository.getFacilityById(builtCode);
        if (facility == null){
